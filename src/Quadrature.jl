...
function layout_gauss_legendre_1d( element_count::Function, element_degree::Function, #=What's the point of this second input=#gauss_legendre_rules )
    quadrature_points = zeros( 0 )
    quadrature_weights= zeros( 0 )
    element_id_at_quadrature_point = zeros( Int64, 0 )
    for e in 1 : element_count()
        quadrature_points_e, quadrature_weights_e = rule_gauss_legendre_1d( element_degree( e ) + 1 )
